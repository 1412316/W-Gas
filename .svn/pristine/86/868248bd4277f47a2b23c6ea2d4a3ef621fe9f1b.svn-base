...
class Main2 extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            isShowMenu: [true, true, true, true, true, true, true, true, true, true, true, true, true, true, true],
            avatar: "",
    ...
    async getUser() {
        ...
        if (typeof (user) !== "undefined") {
            ...
            if (this.state.user.user.userType === Constant.SUPERADMIN || this.state.user.user.userType === Constant.GOVERMENT) {
                this.setState({
                    isShowMenu: [false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true],
                    isShowDriver: true,
            ...
            else if ((this.state.user.user.userType === Constant.FACTORY && this.state.user.user.userRole !== 'Deliver' && this.state.user.user.userRole !== 'Inspector')) {
                if (this.state.user.user.userRole === 'SuperAdmin') {
                    this.setState({
                        isShowMenu: [true, false, false, true, true, true, true, true, true, true, false, true, true, true],
                        isShowDriver: true,
                        isShowGoogleMap: true,
                        isShowThanhtra: false,
                        isShowCalender: false,
                    ...
                    this.setState({
                        isShowMenu: [true, false, false, false, true, true, true, true, true, false, false, false, false, false],
            ...
            } else if (this.state.user.user.userType === Constant.STATION && this.state.user.user.userRole !== 'Deliver' && this.state.user.user.userRole !== 'Inspector') {
                this.setState({
                    isShowMenu: [true, false, false, false, false, false, true, false, true, false],
                    isShowDriver: true,
                    isShowGoogleMap: true,
                    isShowThanhtra: false,
                    isShowCalender: true,
            ...
            } else if (this.state.user.user.userType === Constant.GENERAL && this.state.user.user.userRole !== 'Deliver' && this.state.user.user.userRole !== 'Inspector') {
                this.setState({
            ...
            } else if (this.state.user.user.userType === Constant.FIXER && this.state.user.user.userRole !== 'Deliver' && this.state.user.user.userRole !== 'Inspector') {
                this.setState({
                    isShowMenu: [true, false, false, false, false, false, true, false, false, false],
                    isShowDriver: true,
                    isShowGoogleMap: false,
            ...
            } else if (this.state.user.user.userType === Constant.AGENCY && this.state.user.user.userRole !== 'Deliver' && this.state.user.user.userRole !== 'Inspector') {
                if (this.state.user.user.parentRoot === "")
                    this.setState({
                        isShowMenu: [false, false, false, false, false, false, true, false, true, true, true],
                        isShowDriver: true,
                        isShowGoogleMap: false,
                        isShowThanhtra: false,
                        isShowCalender: false,
            ...
            } else if (this.state.user.user.userType === Constant.NORMAL && this.state.user.user.userRole !== 'Deliver' && this.state.user.user.userRole !== 'Inspector') {
                this.setState({
            ...
            else if (this.state.user.user.userRole === 'Deliver' || this.state.user.user.userRole === 'Inspector') {
                this.setState({
    ...
    render() {
        return (
            <div >
                <aside className="sidebar sidebar-icons-right sidebar-icons-boxed sidebar-expand-lg" style={{ backgroundColor: "#009347" }}>
                    <header className="sidebar-header">
                        <a className="logo-icon" /*href="../index.html"*/>
                            <img src="assets/img/gas-south-logo.png" alt="logo icon" onClick={() => this.reloadPage()}/></a>
                    </header>
                    ...
                    <nav className="sidebar-navigation" style={{ overflow: 'auto' }}>
                        <ul className="menu">
                            <li data-toggle="collapse" data-target="#products" className="collapsed menu-item"
                                style={!this.state.isShowMenu[8] ? { display: "none" } : {}}
                                className={this.state.isMenuIndex === 6 ? "menu-item active1" : "menu-item"}
                            >
                                <Link className="menu-link" onClick={() => this.setState({ isMenuIndex: 6 })} >
                                    <i class="fa fa-suitcase" aria-hidden="true" ></i><span className="kinhdoanh">Quản trị dữ liệu</span><i class="fa fa-plus"></i>
                                </Link>

                            </li>

                            <div class="sub-menu collapse" id="products" >
                                ...
                                <li style={!this.state.isShowMenu[13] ? { display: "none" } : {}}
                                    ...
                                    <Link onClick={() => this.setState({ isMenuIndex: 13 })} to="/factory-child"
                                        ...
                                        <span className="title">Công ty con - CN trực thuộc</span>
                                    </Link>
                                </li>
                                ...
                                <li style={!this.state.isShowMenu[4] ? { display: "none" } : {}}
                                    className={this.state.isMenuIndex === 2 ? "menu-item active1" : "menu-item"}>
                            ...
                            <li style={!this.state.isShowAgencyGeneral ? { display: "none" } : {}}
                                className={this.state.isMenuIndex === 4 ? "menu-item active1" : "menu-item"}>
                                <Link onClick={() => this.setState({ isMenuIndex: 4 })} to="/agency"
                                    className="menu-link ">
                                    <i className="fa fa-cart-plus" aria-hidden="true"></i>
                            ...
                            <li style={!this.state.isShowCalender ? { display: "none" } : {}}
                                ...
                                <Link onClick={() => this.setState({ isMenuIndex: 17 })} to="/createCalenderInspector"
                                    ...
                                    <span style={{ fontFamily: 'roboto', textTransform: 'capitalize' }}>Tạo lịch bảo trì </span>
                                </Link>
                            ...
                            >
                                <Link onClick={() => this.setState({ isMenuIndex: 16 })} to="/thanh-tra"
                                    ...
                                    <span style={{ fontFamily: 'roboto', textTransform: 'capitalize' }}> Người kiểm tra, bảo trì </span>
                                </Link>
                            ...
                            <li className="dropdown">
                                <span className="topbar-btn" data-toggle="dropdown">
                                    <img className="avatar"
                                        ...
                                        alt="..." />
                                    <span className="seednet-mobile-none" style={{ marginLeft: "5px" }}>
                                        <span className="fs-16">
                                            <label>{this.state.user.user ? this.state.user.user.name : ''}</label>
                                            <i className="fa fa-angle-down" style={{ marginLeft: "5px", color: "#009347" }}></i>
                                        </span>
                                    </span>
                                </span>
