...
class AddUserPopupContainer extends React.Component {
    ...
    async addUser(email, name, address, password, userType, child, userRole, owner, code, lat, lng) {
        ...
        const user = await addUserAPI(child, email, name, address, password, userType, userRole, (owner === false ? owner : user_cookies.user.id), code, lat, lng);
    ...
    async updateUser(id, name, password, address, lat, lng) {
        ...
        // Update user
        this.setState({ isLoading: true });
        const user = await updateUserAPI(id, name, password, address, lat, lng);
        this.setState({ isLoading: false });
        //console.log('register',user);
        if (user) {
            console.log(user);
