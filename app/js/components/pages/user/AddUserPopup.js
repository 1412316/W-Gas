                        ...
                        <label>
                          {this.props.isCreateMode
                            ? (this.props.isGeneralPage 
                              ? "Tên khách hàng" : this.props.isAgencyPage 
                              ? "Tên khách hàng" : this.props.isFactoryChildPage 
                              ? "Tên công ty con/ Chi nhánh" : this.props.isFixerPage 
                              ? "Tên nhà máy" : "Tên thương nhân sở hữu")
                            : (this.props.isFactoryPage 
                            ? "Chỉnh Sửa Thông Tin Thương Nhân Sở Hữu" : this.props.isGeneralPage 
                            ? "Tên khách hàng" : this.props.isAgencyPage 
                            ? "Tên khách hàng" : this.props.isFactoryChildPage 
                            ? "Tên công ty con/ Chi nhánh" : this.props.isFixerPage
                            ? "Tên nhà máy" : "")}
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <label>
                            {this.props.isCreateMode
                              ? (this.props.isGeneralPage 
                                ? "Mã khách hàng" : this.props.isAgencyPage 
                                ? "Mã khách hàng" : this.props.isFactoryChildPage 
                                ? "Mã chi nhánh" : this.props.isFixerPage 
                                ? "Mã chi nhánh" : "Mã thương nhân sở hữu")
                              : ''}
                          </label>
                          <Input
                            className="form-control"
