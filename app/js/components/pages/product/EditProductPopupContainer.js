...
class EditProductPopupContainer extends React.Component {
    ...
    async editProduct(serial, color, checkedDate, weight, placeStatus, status, /*currentImportPrice,*/ manufactureId, selectedFile, valve, classification) {
        console.log("manufactureId", manufactureId);
        // Call api
        this.setState({isLoading: true});
        const product = await UpdateProduct(serial, color, checkedDate, weight, placeStatus, status, this.props.product_id, /*currentImportPrice,*/ manufactureId, selectedFile, valve, classification);
