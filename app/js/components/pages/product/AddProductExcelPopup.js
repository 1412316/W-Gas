...
class AddProductExcelPopup extends React.Component {
    ...
    handleFileUpload = (event) => {
        ...
        console.log("lalalalaaaa", this.state)
    }
    ...
    handleChangeFixer = (langValue) => {
        this.setState({ ListUserSubmit: langValue, ListUserSubmitID: langValue.id },
            () => {
                console.log('ducvidai', this.state.ListUserSubmitID)
            });
    }
    ...
    async submit(event) {
        ...
        console.log("this.state.usingType", this.state.usingType);
        console.log("this state manu", this.state.manufacture.id);
