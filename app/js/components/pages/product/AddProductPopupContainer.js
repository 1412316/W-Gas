...
class AddProductPopupContainer extends React.Component {
    ...
    async addProduct(serial, color, checkedDate, weight, placeStatus, status, /*currentImportPrice, cylinderType*/classification, manufacture, valve,manufacturedBy, listconttycon) {

        // Call api
        this.setState({ isLoading: true });
        const product = await addProductAPI(serial, color, checkedDate, weight, placeStatus, status, /*currentImportPrice, cylinderType*/classification, manufacture, valve, manufacturedBy, listconttycon);
