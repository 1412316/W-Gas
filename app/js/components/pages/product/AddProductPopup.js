...
class AddProductPopup extends React.Component {
    ...
    async submit(event) {
        ...
        await this.props.addProduct(
            ...
            data.checkedDate,
            data.weight,
            (this.state.user_type === "Factory") ? Constants.PLACESTATUS_ENUM[0].key : Constants.PLACESTATUS_ENUM[6].key,
            "EMPTY",
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="form-group group">
                                                ...
                                                <Radio.Group onChange={this.onChangeCurrent} value={value} className="">
                                                    <Radio
                                                        ...
                                                        <label
                                                            ...
                                                            name="factoryy"
                                                        >
                                                            {this.state.user_type === "Factory" ? "Vị trí hiện tại: Tại thương nhân sở hữu" : "Vị trí hiện tại: Tại Đại lý - Nhà hàng"}
                                                        </label>
                                                    </Radio>
                                                    <Radio
                                                        style={radioStyle}
                                                        ...
                                                        onChange={this.onChangeCurrent}
                                                    >
                                                        <label className="group1">{this.state.user_role === "cylinderAt_childFactory" ? "Vị trí hiện tại: Tại thương nhân sở hữu" : "Vị trí hiện tại: Tại Công ty - Chi nhánh trực thuộc"}</label>
                                                ...
                                                {/* <label>{this.state.user_type === "Factory" ? "Vị trí hiện tại: Tại thương nhân sở hữu" : "Vị trí hiện tại: Tại Đại lý - Nhà hàng"} </label> */}
                                            </div>
                                        </div>
